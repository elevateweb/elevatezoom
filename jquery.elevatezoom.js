	...
	var ElevateZoom = {
			...
			swaptheimage: function(smallimage, largeimage){
				...
				newImg.onload = function() {
					self.largeWidth = newImg.width;
					self.largeHeight = newImg.height;
					self.zoomImage = self.largeimage;
					self.swapAction(smallimage);
					return;              
				}          
				newImg.src = self.largeimage; // this must be done AFTER setting onload

			},
			swapAction: function(smallimage){
				...
				self.zoomWindow.css({ backgroundImage: "url('" + self.largeimage + "')" }); 

				self.currentImage = self.largeimage;
			...
			doneCallback: function(){
				...
				if(self.options.tint) {
					self.zoomTintImage.attr("src",self.largeimage);
